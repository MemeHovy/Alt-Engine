[![Alt engine](https://github.com/Fearester/Alt-Engine/actions/workflows/main.yml/badge.svg)](https://github.com/Fearester/Alt-Engine/actions/workflows/main.yml)
...
### Credits:
* Fearester - Programmer
* Stefan[BETA]™ - Collobarator Of Alt Engine
...
## New options
• Health Drain 
• Judgement Counter (Count, percent)
• 2 new time bar types (Position Song - Song Length , Song Percentage)
• Volume (Instrumental , Voices)
