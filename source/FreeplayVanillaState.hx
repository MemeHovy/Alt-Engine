...
class FreeplayVanillaState extends MusicBeatState{
	...
	override function create()
	{
		...
		addSong('Bopeebo', 2, 'dad', FlxColor.PURPLE);
		addSong('Fresh', 3, 'dad', FlxColor.PURPLE);
		addSong('Dad Battle', 4, 'dad', FlxColor.PURPLE);
		addSong('Spookezz', 5, 'spooky', FlxColor.ORANGE);
		addSong('South', 6, 'spooky', FlxColor.ORANGE);
		addSong('Monster', 7, 'monster', FlxColor.YELLOW);
		addSong('Pico', 8, 'pico', FlxColor.LIME);
		addSong('Philly Nice', 9, 'pico', FlxColor.LIME);
		addSong('Blammed', 10, 'pico', FlxColor.LIME);
		addSong('Satin Panties', 11, 'mom', FlxColor.PINK);
		addSong('High', 12, 'mom', FlxColor.PINK);
		addSong('Milf', 13, 'mom', FlxColor.PINK);
		addSong('Cocoa', 14, 'parents', FlxColor.PURPLE);
		addSong('Eggnog', 15, 'parents', FlxColor.PURPLE);
		addSong('Winter Horrorland', 16, 'monster', FlxColor.YELLOW);
		addSong('Senpai', 17, 'parents', FlxColor.ORANGE);
		addSong('Roses', 18, 'parents', FlxColor.ORANGE);
		addSong('Thorns', 19, 'monster', FlxColor.RED);
