...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if android
			var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 24, 0, "Press C For Official Discord Server", 16);
			#else
			var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 24, 0, "Press CTRL For Official Discord Server", 18);
		#end
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.pressed.CONTROL #if android || virtualPad.buttonC.justPressed #end) {
			CoolUtil.browserLoad('https://discord.gg/jep7keJdxD');
